...
Avg_HB_prescriptions <- ECP_prescriptions_population_rate %>%
  ...
  tab_header(title = md("**Average rate of Emergency Contraception prescribed per Health Board in Scotland**"),
             ...
             subtitle = md("This table summarises the average prescription of *ECP* from 2019 to 2022. Health Board names are arranged from those with the most to the least ECP prescriptions per 10,000 women.")) %>%
