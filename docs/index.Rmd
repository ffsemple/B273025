...
#prescriptions of ECP are relatively tiny when compared to quantity of antibiotics prescribed - preventing observation of trends in ECP. Could use patchwork to present to separate ggplots 


ECP <- all_prescriptions_2023 %>% 
  filter(str_detect(bnf_item_description, "LEVONO|ULIPR"))
