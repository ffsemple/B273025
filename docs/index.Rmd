...
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE, cache=FALSE, fig.align = "center", fig.width = 8, fig.height = 5) # align figures to centre and set dimensions to prevent them being cut off 
```
...
# Convert the ggplot to a Plotly interactive plot and center it
ECP_SIMD_barchart <- htmltools::div(plotly::ggplotly(ECP_SIMD_barchart, tooltip = "text", width = 800, height = 400), style = "text-align: center;")
